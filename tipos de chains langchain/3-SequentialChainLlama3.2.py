...
)  # Nota: LLMChain está deprecado va tirar mensaje relacionado con eso pero va a funcionar igual
...
review = df.Review[9]  # Selecciona la reseña en la posición 5 del DataFrame
